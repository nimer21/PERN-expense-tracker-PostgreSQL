            ...
            <form onSubmit={(e) => handleSearch(e)}>
              <div className="w-full flex  items-center gap-2 border border-gray-300 dark:border-gray-600 rounded-md px-2 py-2">
                ...
                <input
                  ...
                  className="ouline-none group bg-transparent text-gray-700 dark:text-gray-400 placeholder:text-gray-600"
                />
              </div>
            </form>
            <button
              ...
              className="flex items-center justify-center gap-2 bg-black dark:bg-violet-800 py-1.5 px-2 rounded text-white"
            >
              {/* <MdDateRange /> */}
              <MdAdd size={22} />
